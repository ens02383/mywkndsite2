...
var CustomImportScript = (() => {
  ...
  // import-winter-adventures.js
  var import_winter_adventures_exports = {};
  __export(import_winter_adventures_exports, {
    default: () => import_winter_adventures_default
  });
  ...
  // transformers/mywkndsite2-cleanup.js
  ...
  // transformers/mywkndsite2-sections.js
  ...
  var PAGE_TEMPLATE = {
    ...
    "description": "Seasonal landing page: hero carousel, grey featured-article columns, winter trips card grid, and a full-width hero feature",
    "urls": [
      "http://localhost:8765/us/en/winter-adventures.html"
    ],
    "blocks": [
      {
        "name": "carousel",
  ...
  var import_winter_adventures_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_winter_adventures_exports);
})();
